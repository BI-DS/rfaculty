# This file removes the Solutions in a Quarto file provided the solutions
# start with ### Sol.
# TODO:
#  1. Check for nested ### Sol and throw an error.
#  2. ?
...
def process_all_qmd_files():
    ...
    qmd_files = [file for file in qmd_files if not file.endswith("_unsolved.qmd")]
